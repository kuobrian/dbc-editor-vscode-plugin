...
interface ISignalTableState {
  selectSignal: any[];
  show: boolean;
}

interface ITransmittersTableState {
  selectTransmitters: any[];
  show: boolean;
}

class SelectSignalTable extends React.Component <IMsgProps, ISignalTableState> {
  constructor(props) {
    super(props);
...
class SelectTransmittersTable extends React.Component <IMsgProps, ITransmittersTableState> {
  constructor(props) {
    super(props);
                ...
                <Modal.Body>
                    <Table  striped bordered hover variant="dark">
                        ...
                        <tbody>
                              { 
                                this.props.allSignals.map((item, idx) => {
                                  if (! this.state.selectTransmitters.includes(item)) {
                                    return (
                                      <tr>
                                        <td>{item.name} {this.state.selectTransmitters.includes(item)}</td> 
                                        <td>{item.bitlength}</td>
                                        <td>
                                          <Button variant="primary" onClick={() => this.handleSelectSignal(item)}>
                                          add
